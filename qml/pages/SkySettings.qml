        ...
        Column {
            ...
            Item {
                ...
                Image {
                    ...
                    source: skyAccount.picture
                    asynchronous: true
                    smooth: true
                    height: Theme.itemSizeSmall
                    width: height
                    fillMode: Image.PreserveAspectFit
                    visible: skyAccount.picture!==""
                }

                Column {
                    anchors.left: skyAccount.picture!==""? userPic.right : parent.left
                    anchors.leftMargin: skyAccount.picture!==""? Theme.paddingMedium : 0
                    anchors.verticalCenter: userPic.verticalCenter

                    Label {
                        text: skyAccount.user
                    }

                    Label {
                        text: skyAccount.email
            ...
            ProgressCircleBase {
                ...
                height: width
                anchors.horizontalCenter: parent.horizontalCenter
                value: skyAccount.spaceUsed / skyAccount.spaceTotal
                borderWidth: 2
                ...
                Column {
                    ...
                    Text {
                        ...
                        width: paintedWidth
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: skyAccount.spaceTotalText
                    }
                }
            ...
            ValueButton {
                ...
                value: getName(config.readConfig("OneDrive/upload_folder","/||/").split("||")[0])
                onClicked: {
                    pageStack.push("SkyUploadFolder.qml")
                }
            }
