#ifndef DRIVECLIENT_H
#define DRIVECLIENT_H
...
//#include "drivetransfers.h"

#include <QXmlStreamReader>

class DriveClient : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    explicit DriveClient(QObject * parent = 0);
    virtual ~DriveClient();
...
public slots:
    ...
    void handleFileInfo(QNetworkReply *networkReply);
...
private:
    ...
    class DriveClientPrivate;
    DriveClientPrivate * const d;
    DriveThumbnailer *pepe;
    //DriveTransfers *transfers;
