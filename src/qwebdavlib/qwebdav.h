...
public:
    ...
    QNetworkReply* propfind2(QString path, QStringList props);
...
signals:
    ...
    void readReadyRead(QNetworkReply*);
...
protected:
    QNetworkReply* createRequest(const QString& method, QNetworkRequest& req, QIODevice* outgoingData = 0, bool addSize = true);
    QNetworkReply* createRequest(const QString& method, QNetworkRequest& req, const QByteArray& outgoingData, bool addSize = true);
